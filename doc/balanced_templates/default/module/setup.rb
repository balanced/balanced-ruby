...
def init
  # HACK: Yard wants to print "Top Level Namespace" without this
  return if object.to_s == ''
  # HACK: don't print the Balanced namespace itself
  return if object.to_s == 'Balanced'
  sections :header,
#  :box_info,
  :pre_docstring,  T('docstring'), :children,
