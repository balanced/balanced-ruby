...
% elif mode == 'response':
#<Balanced::Card:0x007fefda3d7968
 @attributes=
  {"address"=>
    {"city"=>nil,
     "country_code"=>nil,
 ...
 @hyperlinks=
  {"card_holds"=>
    #<Proc:0x007fefda3d58e8/lib/balanced/utils.rb:6 (lambda)>,
   "customer"=>
    #<Proc:0x007fefda3d4f38/lib/balanced/utils.rb:6 (lambda)>,
   "debits"=>
    #<Proc:0x007fefda3df0a0/lib/balanced/utils.rb:6 (lambda)>}>
