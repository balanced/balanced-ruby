...
% elif mode == 'response':
[#<Balanced::Reversal:0x007fefdb8d3e20
  @attributes=
   {"amount"=>3000,
  ...
  @hyperlinks=
   {"credit"=>
     #<Proc:0x007fefdb8d22f0/lib/balanced/resources/resource.rb:60 (lambda)>,
    "events"=>
     #<Proc:0x007fefdb8d04a0/lib/balanced/utils.rb:6 (lambda)>,
    "order"=>
     #<Proc:0x007fefda2ffa90/lib/balanced/utils.rb:6 (lambda)>}>]
