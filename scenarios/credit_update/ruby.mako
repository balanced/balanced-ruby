...
% elif mode == 'response':
#<Balanced::Credit:0x007fefdb9da990
 @attributes=
  {"amount"=>5000,
 ...
 @hyperlinks=
  {"customer"=>
    #<Proc:0x007fefdb9d8e60/lib/balanced/resources/resource.rb:60 (lambda)>,
   "destination"=>
    #<Proc:0x007fefdb9e34a0/lib/balanced/resources/resource.rb:60 (lambda)>,
   "events"=>
    #<Proc:0x007fefdb9e1650/lib/balanced/utils.rb:6 (lambda)>,
   "order"=>
    #<Proc:0x007fefdb9e0c78/lib/balanced/utils.rb:6 (lambda)>,
   "reversals"=>
    #<Proc:0x007fefdb9e2cf8/lib/balanced/utils.rb:6 (lambda)>}>
