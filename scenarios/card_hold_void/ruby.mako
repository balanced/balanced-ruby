...
card_hold.void
% elif mode == 'response':
#<Balanced::CardHold:0x007ff2bdaffa98
 @attributes=
  {"amount"=>5000,
 ...
 @hyperlinks=
  {"card"=>
    #<Proc:0x007ff2bdafcc30/lib/balanced/resources/resource.rb:60 (lambda)>,
   "debit"=>
    #<Proc:0x007ff2bdaf07a0/lib/balanced/utils.rb:6 (lambda)>,
   "debits"=>
    #<Proc:0x007ff2bdaf1ce0/lib/balanced/utils.rb:6 (lambda)>,
   "events"=>
    #<Proc:0x007ff2bdafb150/lib/balanced/utils.rb:6 (lambda)>}>
