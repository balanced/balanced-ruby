...
account.settlements
% elif mode == 'response':
[#<Balanced::Settlement:0x007fcde10b5cc8
  @attributes=
   {"amount"=>1000,
  ...
  @hyperlinks=
   {"credits"=>
     #<Proc:0x007fcde10af580/lib/balanced/utils.rb:6 (lambda)>,
    "destination"=>
     #<Proc:0x007fcde10a3280/lib/balanced/resources/resource.rb:56 (lambda)>,
    "events"=>
     #<Proc:0x007fcde109a6a8/lib/balanced/utils.rb:6 (lambda)>,
    "reversals"=>
     #<Proc:0x007fcde1081ce8/lib/balanced/utils.rb:6 (lambda)>,
    "source"=>
     #<Proc:0x007fcde1808cc8/lib/balanced/resources/resource.rb:56 (lambda)>}>]
