...
% elif mode == 'response':
#<Balanced::Reversal:0x007fa6d215ed40
 @attributes=
  {"amount"=>3000,
 ...
 @hyperlinks=
  {"credit"=>
    #<Proc:0x007fa6d215d120/lib/balanced/resources/resource.rb:60 (lambda)>,
   "events"=>
    #<Proc:0x007fa6d2157180/lib/balanced/utils.rb:6 (lambda)>,
   "order"=>
    #<Proc:0x007fa6d21567d0/lib/balanced/utils.rb:6 (lambda)>}>
